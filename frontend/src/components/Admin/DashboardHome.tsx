    ...
    <div className='w-full h-full flex flex-col'>
      <div className='flex flex-row justify-between items-center w-full pt-[30px]'>
        ...
        <div className='flex flex-row gap-3'>
          <button className='flex flex-row gap-2 justify-between items-center bg-white text-black border-black border-1 text-sm'> <Pencil className='w-4 h-5' />Manage Books</button>
          <button className='flex flex-row gap-2 justify-between items-center text-sm'> <Plus className='w-4 h-5' /> Add New Books</button>
        </div>
        </div>
      <div className='flex flex-row justify-between items-center gap-3 my-[30px] mx-[5px]'>
          ...
          <div className='flex flex-row justify-between items-center gap-3 bg-gray-100 rounded-md w-[280px] h-[100px] p-[20px]  hover:shadow-md'>
            ...
            <div className='flex flex-col justify-between items-center gap-3'>
              <h3 className='font-medium text-lg flex flex-row'>{trendingBooks.length} (<p>{FilterBooksProps.length/100 * trendingBooks.length} %</p>)</h3>
