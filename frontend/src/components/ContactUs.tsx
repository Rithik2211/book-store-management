  ...
  return (
    <div className='flex flex-col lg:flex-row justify-between items-center gap-5 lg:gap-[180px] w-full px-4 md:px-6 lg:px-8'>
        <div className='flex flex-col justify-start items-center lg:items-start gap-[20px] w-full lg:w-auto'>
            <div className="relative w-full max-w-[150px] md:max-w-[200px] mx-auto lg:mx-0">
        ...
        <div className='flex flex-col justify-start items-start gap-4 w-full lg:w-auto mt-8 lg:mt-0'>
            ...
            <div className='border-[1.5px] rounded-[5px] w-full relative'>
                <input  className='w-full px-4 text-xs sm:text-sm bg-transparent border-none outline-none' type='text' placeholder='Enter your email address' value={text} onChange={(e) => handleTextChange(e)}/>
                <div className="absolute right-0 top-0 h-full px-3 py-1 sm:py-0 sm:px-[40px] text-center bg-black text-white text-xs sm:text-sm rounded-r-[5px]">
                    Subscribe
                </div>
            </div>
        </div>
