                                ...
                                <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                    ...
                                    <div className="md:col-span-5 mt-3">
                                        <div className="inline-flex items-center">
                                            ...
                                            <label htmlFor="billing_same" className="ml-2 flex flex-row gap-2">I am aggree to the <div className='underline underline-offset-2 text-blue-600'>Terms & Conditions</div> and <div className='underline underline-offset-2 text-blue-600'>Shoping Policy.</div></label>
                                        </div>
                                    </div>
