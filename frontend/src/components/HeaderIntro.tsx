...
const HeaderIntro = () => {
  return (
    <div className='flex flex-col md:flex-row justify-between items-center py-16 gap-12'>
        <div className=' md:w-1/2 w-full flex flex-col items-start text-start gap-4'>
        ...
        <div className="md:w-1/2 w-full flex md:items-center justify-end">
            <img 
                src="/headerTitle.svg" 
